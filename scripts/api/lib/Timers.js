      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              if (_a.sent() === true) return [2 /*return*/];
  ...
  function Timeout(idleTimeout, idleStart, onTimeout, repeat, destroyed) {
    ...
    var _this =
      _super.apply(
        this,
        __spreadArray(
          [idleTimeout, idleStart, onTimeout, repeat, destroyed],
          args,
          false
        )
      ) || this;
...
function setTimeout(callback, ms) {
  ...
  // @ts-ignore
  return new (Timeout.bind.apply(
    Timeout,
    __spreadArray(
      [void 0, idleTime, startTime, callback, false, false],
      args,
      false
    )
  ))();
...
function setInterval(callback, ms) {
  ...
  var startTime = new Date().getTime();
  // @ts-ignore
  return new (Timer.bind.apply(
    Timer,
    __spreadArray(
      [void 0, idleTime, startTime, callback, true, false],
      args,
      false
    )
  ))();
...
function setImmediate(callback) {
  ...
  Validation(callback, Function);
  // @ts-ignore
  return new (Immediate.bind.apply(
    Immediate,
    __spreadArray([void 0, callback], args, false)
  ))();
}
/**
 * By passing said object into the respective clear function,
